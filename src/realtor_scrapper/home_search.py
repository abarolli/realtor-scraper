...
class RealtorProperties:
    ...
    def find(
        ...
        return self.__get_homes(urlbuilder)
        
    def __get_homes(self, urlbuilder: RealtorSearchURLBuilder):
        res = requests.get(urlbuilder.url, headers=self.__headers)
